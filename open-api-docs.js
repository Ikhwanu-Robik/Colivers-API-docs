window.apiDocs = {
  ...
  "info": {
    ...
    "description": "Find Roommate is a platform for you to find a roommate, mainly to share the lodging's rent because who can afford rent alone in this economy?",
    "version": "1.0.0"
  },
  "servers": [
    {
  ...
  "paths": {
          ...
          "200": {
            ...
            "headers": {
              ...
              "Server": {
                "schema": {
                  "type": "number",
                  "example": "Apache/2.4.54 (Win64) OpenSSL/1.1.1q mod_fcgid/2.3.10-dev"
                }
              },
              "X-Powered-By": {
                "schema": {
                ...
                "example": {
                  "user": {
                    ...
                    "profile": {
                      ...
                      "profile_photo": "profile_pics/QZCZS6kmi17jfZUvxRlxmndqsoTG6o1P6xFdrCPw.jpg",
                      "created_at": "2026-01-02T06:18:52.000000Z",
                      "updated_at": "2026-01-02T06:18:52.000000Z"
                    }
                  },
                    ...
                    "value": {
                      "user": {
                        ...
                        "profile": {
                          ...
                          "address": "Paranggupito",
                          "bio": "Ibadah, berdoa, dan solat pada Tuhan",
                          "profile_photo": "profile_pics/V2F1p8YjAVomhnCAwbwVOb2vE3etWkVymEiImYvr.jpg",
                          "created_at": "2026-01-02T06:23:12.000000Z",
                          "updated_at": "2026-01-02T06:23:12.000000Z"
                        }
                      },
    ...
    "/listing": {
      "post": {
        ...
        "description": "After sending this request, the current user will be searchable in profiles recommendation.\n\nSending it again will update the lodging_id.",
        "requestBody": {
          "content": {
            "multipart/form-data": {
              "schema": {
            ...
            "content": {
              "application/json": {
                ...
                "example": {
                  ...
                  "errors": {
                    "lodging_id": [
                      "The lodging id field is required."
                    ]
                  }
                }
              }
                      ...
                      "matching_profiles": [
                        {
                          ...
                          "customer_profile": {
                            ...
                            "address": "512 O'Conner Flat Apt. 922\nPort Wilma, MA 83120-0502",
                        ...
                        },
                        {
                          ...
                          "customer_profile": {
                            ...
                            "address": "47277 Edna Via Apt. 724\nEast Inesmouth, MI 66387",
          ...
          "422": {
            ...
            "content": {
              "application/json": {
                ...
                "example": {
                  "message": "The gender must be either male or female (and 4 more errors)",
                  "errors": {
                    "gender": [
                      "The gender must be either male or female"
                    ],
                    "min_age": [
                      "The min age field must be at least 17."
                    ],
                    "max_age": [
                      "The max age field must be greater than or equal to 15."
                    ],
                    "lodging_id": [
                      "The selected lodging id is invalid."
                    ],
                    "bio": [
                      "The bio field is required."
                    ]
    ...
    "/match/profiles/{customer_profile_id}/chat": {
      "post": {
        ...
        "description": "The 1 in /match/profiles/1/chat is a customer_profile_id which can be obtained from profiles recommendation",
        "requestBody": {
          "content": {}
        },
        "security": [
    ...
    "/chat-rooms/{chat_room_id}/chats": {
      "post": {
        ...
        "summary": "send a chat",
        "description": "The 2 in /chat-rooms/2/chats is a chat_room_id that can be obtained from /api/match/profiles/{customer_profile_id}/chat.",
        "requestBody": {
          "content": {
            "multipart/form-data": {
              "schema": {
          ...
          "200": {
            ...
            "headers": {
              ...
              "Date": {
                "schema": {
                  "type": "string",
                  "example": "Sun, 04 Jan 2026 06:32:21 GMT"
                }
              },
              "Content-Type": {
                "schema": {
            ...
            "content": {
              "application/json": {
                ...
                "example": {
                  "customer_profile": {
                    "id": 1,
                    "full_name": "Ajeng Febria",
                    "gender": "female",
                    "birthdate": "2008-04-05",
                    "address": "Rejosari, Jatisrono",
                    "bio": "Programmer Laravel di laptop",
                    "profile_photo": "profile_pics/H4Vff3I7dJV0B9ZPuwfsSQAJ9hOfDDIF9xFY5g8W.jpg",
                    "created_at": "2025-12-27T12:52:09.000000Z",
                    "updated_at": "2026-01-04T06:32:21.000000Z"
                  }
                }
              }
            }
          ...
          "401": {
            ...
            "headers": {
              ...
              "Date": {
                "schema": {
                  "type": "string",
                  "example": "Sun, 04 Jan 2026 06:18:06 GMT"
                }
              },
              "Content-Type": {
                "schema": {
          ...
          "403": {
            ...
            "headers": {
              ...
              "Date": {
                "schema": {
                  "type": "string",
                  "example": "Sun, 04 Jan 2026 06:27:57 GMT"
                }
              },
              "Content-Type": {
                "schema": {
          ...
          "422": {
            ...
            "headers": {
              ...
              "Date": {
                "schema": {
                  "type": "string",
                  "example": "Sun, 04 Jan 2026 06:29:26 GMT"
                }
              },
              "Content-Type": {
                "schema": {
            ...
            "content": {
              "application/json": {
                ...
                "example": {
                  "message": "The birthdate must be past date (and 1 more error)",
                  "errors": {
                    "birthdate": [
                      "The birthdate must be past date"
                    ],
                    "profile_photo": [
          ...
          "500": {
            ...
            "headers": {
              ...
              "Date": {
                "schema": {
                  "type": "string",
                  "example": "Sun, 04 Jan 2026 06:34:24 GMT"
                }
              },
              "Content-Type": {
                "schema": {
